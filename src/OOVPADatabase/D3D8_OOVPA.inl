...
OOVPATable D3D8_OOVPA[] = {
    ...
    REGISTER_OOVPAS_D3D(SYM_FUN(CDevice_InitializeFrameBuffers, CALL(thi), STACK(/*default*/), PARAMS(PARAM(ecx, this), PARAM(stk, pPresentationParams))),
    ...
    REGISTER_OOVPAS_D3D(SYM_FUN(CDevice_SetStateVB, CALL(thi), STACK(/*default*/), PARAMS(PARAM(ecx, this), PARAM(stk, unknown2))), // TODO: Update unknown parameter name(s) if able.
                        SYM_SIG(3911, 4034)), // Final generic OOVPA: 4034; Removed: 0

    REGISTER_OOVPAS(SYM_FUN(D3D_CreateTexture, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Width), PARAM(stk, Height), PARAM(stk, Depth), PARAM(stk, Levels), PARAM(stk, Usage), PARAM(stk, Format), PARAM(stk, isCube), PARAM(stk, isVolume), PARAM(stk, ppTexture))),
                    SYM_SIG(3911, 4034)),
    ...
    REGISTER_OOVPAS_D3D(SYM_FUN(CMiniport_CreateCtxDmaObject, CALL(thi), STACK(/*default*/), PARAMS(PARAM(ecx, this), PARAM(stk, unknown1), PARAM(stk, unknown2), PARAM(stk, unknown3), PARAM(stk, unknown4), PARAM(stk, unknown5))), // TODO: Update unknown parameter name(s) if able.
                        SYM_SIG(3911, 4034)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DBaseTexture_GetLevelCount, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DCubeTexture_GetCubeMapSurface2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, FaceType), PARAM(stk, Level))),
                    SYM_SIG(4627)), // Final generic OOVPA: 4627; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DCubeTexture_GetCubeMapSurface, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, FaceType), PARAM(stk, Level), PARAM(stk, ppCubeMapSurface))),
                    SYM_SIG(3911, 4627)), // Final generic OOVPA: 4627; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DCubeTexture_LockRect, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, FaceType), PARAM(stk, Level), PARAM(stk, pLockedBox), PARAM(stk, pRect), PARAM(stk, Flags))),
                    SYM_SIG(3911)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_ApplyStateBlock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Token))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_Begin, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType))),
                    SYM_SIG(3911, 4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_BeginPush, CALL(std), STACK(8), PARAMS(PARAM(stk, Count), PARAM(stk, ppPush))),
                    SYM_SIG(4039)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_BeginPushBuffer, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pPushBuffer))),
                    SYM_SIG(3911, 4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_BeginStateBig, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, unknown1))), // TODO: Update unknown parameter name(s) if able.
                    SYM_SIG(5028)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_BeginVisibilityTest, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_BlockOnFence, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Fence))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_BlockUntilVerticalBlank, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CaptureStateBlock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Token))),
                    SYM_SIG(3911, 4134)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateCubeTexture, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, EdgeLength), PARAM(stk, Levels), PARAM(stk, Usage), PARAM(stk, Format), PARAM(stk, Pool), PARAM(stk, ppCubeTexture))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateImageSurface, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Width), PARAM(stk, Height), PARAM(stk, Format), PARAM(stk, ppBackBuffer))),
                    SYM_SIG(3911, 4034, 4627)), // TODO 4721,4928 (from 4627's comment)
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateIndexBuffer, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Length), PARAM(stk, Usage), PARAM(stk, Format), PARAM(stk, Pool), PARAM(stk, ppIndexBuffer))),
                    SYM_SIG(3911, 4627)), // TODO: This needs to be verified on 4361
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateIndexBuffer2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Length))),
                    SYM_SIG(4627, 5344)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreatePalette, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Size), PARAM(stk, ppPalette))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreatePalette2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Size))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreatePixelShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pPSDef), PARAM(stk, pHandle))),
                    SYM_SIG(3911, 5344)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateStateBlock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Type), PARAM(stk, pToken))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateTexture2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Width), PARAM(stk, Height), PARAM(stk, Depth), PARAM(stk, Levels), PARAM(stk, Usage), PARAM(stk, Format), PARAM(stk, D3DResource))),
                    SYM_SIG(4627, 4831)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateTexture, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Width), PARAM(stk, Height), PARAM(stk, Levels), PARAM(stk, Usage), PARAM(stk, Format), PARAM(stk, Pool), PARAM(stk, ppTexture))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateVertexBuffer, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Length), PARAM(stk, Usage), PARAM(stk, FVF), PARAM(stk, Pool), PARAM(stk, ppVertexBuffer))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateVertexBuffer2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Length))),
                    SYM_SIG(4627, 5344, 5455)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateVertexShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pDeclaration), PARAM(stk, pFunction), PARAM(stk, pHandle), PARAM(stk, Usage))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateVolumeTexture, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Width), PARAM(stk, Height), PARAM(stk, Depth), PARAM(stk, Levels), PARAM(stk, Usage), PARAM(stk, Format), PARAM(stk, Pool), PARAM(stk, ppVolumeTexture))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DeletePatch, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DeletePixelShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle))),
                    SYM_SIG(3911, 5344)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DeleteStateBlock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Token))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DeleteVertexShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle))),
                    SYM_SIG(3911, 5344)), // Final generic OOVPA: 5344; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawIndexedVertices, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType), PARAM(stk, VertexCount), PARAM(stk, pIndexData))),
                    SYM_SIG(3911, 4034)), // Final generic OOVPA: 4034; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawIndexedVerticesUP, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType), PARAM(stk, VertexCount), PARAM(stk, pIndexData), PARAM(stk, pVertexStreamZeroData), PARAM(stk, VertexStreamZeroStride))),
                    SYM_SIG(3911, 5028, 5344)), // Final generic OOVPA: 5344; Removed: 0 // TODO: Need verify title with 4034 version.
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawRectPatch, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, pNumSegs), PARAM(stk, pRectPatchInfo))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawTriPatch, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, pNumSegs), PARAM(stk, pTriPatchInfo))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawVertices, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType), PARAM(stk, StartVertex), PARAM(stk, VertexCount))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawVerticesUP, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType), PARAM(stk, VertexCount), PARAM(stk, pVertexStreamZeroData), PARAM(stk, VertexStreamZeroStride))),
                    SYM_SIG(3911, 4039, 5344)), // Final generic OOVPA: 5344; Removed: 0 // TODO: Need verify title with 4034 version.
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_EnableOverlay, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Enable))),
                    SYM_SIG(3911, 4134)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_End, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(3911, 4039, 5344)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_EndPush, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pPush))),
                    SYM_SIG(4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_EndPushBuffer, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_EndStateBlock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pToken))),
                    SYM_SIG(3911, 4134)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_FlushVertexCache, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(3911, 4134)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetBackBuffer, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, BackBuffer), PARAM(stk, Type), PARAM(stk, ppBackBuffer))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetBackBuffer2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, BackBuffer))),
                    SYM_SIG(4627)), // Final generic OOVPA: 4627; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetBackMaterial, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pMaterial))),
                    SYM_SIG(3911, 4039, 4134, 4627, 5344, 5558, 5788)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetCreationParameters, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pParameters))),
                    SYM_SIG(3911)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetDepthStencilSurface2, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetDeviceCaps, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pCaps))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetDisplayFieldStatus, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pFieldStatus))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetDisplayMode, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pModes))),
                    SYM_SIG(3911, 4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetGammaRamp, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pRamp))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetLight, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Index), PARAM(stk, pLight))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetLightEnable, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Index), PARAM(stk, pEnable))),
                    SYM_SIG(3911, 5344)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetMaterial, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pMaterial))),
                    SYM_SIG(3911, 4039, 4134, 4627, 5344, 5558, 5788)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetModelView, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pModelView))),
                    SYM_SIG(3911, 4039)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetPersistedSurface2, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(4928)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetPixelShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Name), PARAM(stk, pHandle))),
                    SYM_SIG(3911, 4039, 4134, 5028, 5558, 5788)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetProjectionViewportMatrix, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pProjectionViewport))),
                    SYM_SIG(3911, 4134, 4627, 5344, 5558)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetPushBufferOffset, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pOffset))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetRenderTarget2, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(4627)), // Final generic OOVPA: 4627; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetRenderTarget, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, ppRenderTarget))),
                    SYM_SIG(3911, 4627)), // Final generic OOVPA: 4627; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetScissors, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pCount), PARAM(stk, pExclusive), PARAM(stk, pRects))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetShaderConstantMode, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pMode))),
                    SYM_SIG(3911, 4134, 4627, 5028, 5344, 5558, 5788)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetStreamSource2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, StreamNumber), PARAM(stk, pStride))),
                    SYM_SIG(4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetTexture2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Stage))),
                    SYM_SIG(3911, 4134, 4627, 5344, 5558, 5788)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetTile, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Index), PARAM(stk, pTile))),
                    SYM_SIG(3911, 5455)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetTransform, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, State), PARAM(stk, pMatrix))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVertexShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pHandle))),
                    SYM_SIG(3911, 4039, 4134, 5028, 5558, 5788)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVertexShaderConstant, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Register), PARAM(stk, pConstantData), PARAM(stk, ConstantCount))),
                    SYM_SIG(3911, 4039, 5028)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVertexShaderDeclaration, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, pData), PARAM(stk, pSizeOfData))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVertexShaderFunction, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, pData), PARAM(stk, pSizeOfData))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVertexShaderInput, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pHandle), PARAM(stk, pStreamCount), PARAM(stk, pStreamInputs))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVertexShaderSize, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, pSize))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVertexShaderType, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, pType))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetViewport, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pViewport))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetViewportOffsetAndScale, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pOffset), PARAM(stk, pScale))),
                    SYM_SIG(4432)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_GetVisibilityTestResult, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Index), PARAM(stk, pResult), PARAM(stk, pTimeStamp))),
                    SYM_SIG(3911, 5233)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_InsertCallback, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Type), PARAM(stk, pCallback), PARAM(stk, Context))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_LoadVertexShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, Address))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_Present, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pSourceRect), PARAM(stk, pDestRect), PARAM(stk, pUnused3), PARAM(stk, pUnused4))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_PrimeVertexCache, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, VertexCount), PARAM(stk, pIndexData))),
                    SYM_SIG(3911, 4039)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_RunVertexStateShader, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Address), PARAM(stk, pData))),
                    SYM_SIG(3911, 4039)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SelectVertexShaderDirect, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pVAF), PARAM(stk, Address))),
                    SYM_SIG(4361)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetBackBufferScale, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, x), PARAM(stk, y))),
                    SYM_SIG(4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetBackMaterial, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pMaterial))),
                    SYM_SIG(3911, 4039, 4134, 4627, 5344, 5558, 5788)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetDepthClipPlanes, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Near), PARAM(stk, Far), PARAM(stk, Flags))),
                    SYM_SIG(4432)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetFlickerFilter, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Filter))),
                    SYM_SIG(3911, 4034, 4134)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetGammaRamp, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, dwFlags), PARAM(stk, pRamp))),
                    SYM_SIG(3911, 4627)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetLight, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Index), PARAM(stk, pLight))),
                    SYM_SIG(3911, 5344)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetMaterial, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pMaterial))),
                    SYM_SIG(3911, 4034, 4134, 4627, 5344, 5558, 5788)), // Was 4627 (from 5344's comment)
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetModelView, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pModelView), PARAM(stk, pInverseModelView), PARAM(stk, pComposite))),
    ...
    REGISTER_OOVPAS_M(SYM_FUN(D3DDevice_SetRenderState_Simple, CALL(fas), STACK(/*default*/), PARAMS(PARAM(ecx, Method), PARAM(edx, Value))),
                      SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS_M(SYM_FUN(D3DDevice_SetRenderStateNotInline, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, State), PARAM(stk, Value))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, State), PARAM(stk, Value))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, State), PARAM(stk, Value))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_Deferred, CALL(fas), STACK(/*default*/), PARAMS(PARAM(ecx, State), PARAM(edx, Value))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_DoNotCullUncompressed, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_Dxt1NoiseEnable, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_MultiSampleMask, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 4627)), // Final generic OOVPA: 4627; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_MultiSampleMode, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(4034)), // Final generic OOVPA: 4034; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_MultiSampleRenderTargetMode, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(4034)), // Final generic OOVPA: 4034; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_MultiSampleType, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_NormalizeNormals, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_OcclusionCullEnable, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 1024)), // Final generic OOVPA: 3911 (LTCG) / 4034 (non-LTCG); Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_PSTextureModes, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 4034)), // Final generic OOVPA: 4034; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_RopZCmpAlwaysRead, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_RopZRead, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_ShadowFunc, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_StencilCullEnable, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 1024)), // Final generic OOVPA: 3911 (LTCG) / 4034 (non-LTCG); Removed: 0
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_VertexBlend, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetRenderState_YuvEnable, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Value))),
                    SYM_SIG(3911, 1024)), // Final generic OOVPA: 3911 (LTCG) / 4034 (non-LTCG); Removed: 0
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetShaderConstantMode, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Mode))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetSoftDisplayFilter, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Enable))),
                    SYM_SIG(3911, 4034, 4134)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetStipple, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pPattern))),
                    SYM_SIG(4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetStreamSource, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, StreamNumber), PARAM(stk, pStreamData), PARAM(stk, Stride))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetSwapCallback, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pCallback))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetTextureStageStateNotInline, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Stage), PARAM(stk, Type), PARAM(stk, Value))),
                    SYM_SIG(3911, 4034)), // Final generic OOVPA: 4034; Removed: 0
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetTile, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Index), PARAM(stk, pTile))),
                    SYM_SIG(3911, 4034, 4627)), // Then it has changed calls ?SetTileNoWait@D3D@@YGXKPBU_D3DTILE@@@Z in XDK 4627 and higher.
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetTransform, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, State), PARAM(stk, pMatrix))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_MultiplyTransform, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, State), PARAM(stk, pMatrix))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetVertexShaderConstant4, CALL(fas), STACK(/*default*/), PARAMS(PARAM(ecx, Register), PARAM(edx, pConstantData))),
                    SYM_SIG(4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetVertexShaderConstantNotInline, CALL(std), STACK(/*default*/), PARAMS(PARAM(ecx, Register), PARAM(edi, pConstantData), PARAM(stk, ConstantCount))),
                    SYM_SIG(4627, 5028, 5558)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetVertexShaderConstantNotInlineFast, CALL(std), STACK(/*default*/), PARAMS(PARAM(ecx, Register), PARAM(edi, pConstantData), PARAM(stk, ConstantCount))),
                    SYM_SIG(4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetVertexShaderInput, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Handle), PARAM(stk, StreamCount), PARAM(stk, pStreamInputs))),
                    SYM_SIG(3911, 4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetVertexShaderInputDirect, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pVAF), PARAM(stk, StreamCount), PARAM(stk, pStreamInputs))),
                    SYM_SIG(4361)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetVerticalBlankCallback, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pCallback))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SwitchTexture, CALL(fas), STACK(/*default*/), PARAMS(PARAM(ecx, Method), PARAM(edx, Data), PARAM(stk, Format))),
                    SYM_SIG(3911)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DPalette_Lock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, ppColors), PARAM(stk, Flags))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DPalette_Lock2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, Flags))),
                    SYM_SIG(4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DResource_AddRef, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DResource_BlockUntilNotBusy, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis))),
                    SYM_SIG(3911)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DResource_IsBusy, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis))),
                    SYM_SIG(3911, 4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DResource_Register, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, pBase))),
                    SYM_SIG(3911)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DSurface_GetDesc, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, pDesc))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DSurface_LockRect, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, pLockedRect), PARAM(stk, pRect), PARAM(stk, Flags))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DTexture_GetSurfaceLevel, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, Level), PARAM(stk, ppSurfaceLevel))),
                    SYM_SIG(3911, 4627)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DTexture_LockRect, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, Level), PARAM(stk, pLockedRect), PARAM(stk, pRect), PARAM(stk, Flags))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DVertexBuffer_GetDesc, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, pDesc))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3DVertexBuffer_Lock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pVertexBuffer), PARAM(stk, OffsetToLock), PARAM(stk, SizeToLock), PARAM(stk, ppbData), PARAM(stk, Flags))),
                    SYM_SIG(3911, 4034, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DVertexBuffer_Lock2, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pVertexBuffer), PARAM(stk, Flags))),
                    SYM_SIG(4627)),
    REGISTER_OOVPAS(SYM_FUN(D3DVolumeTexture_LockBox, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pThis), PARAM(stk, Level), PARAM(stk, pLockedVolume), PARAM(stk, pBox), PARAM(stk, Flags))),
                    SYM_SIG(3911)), // Just calls Lock3DSurface (from 4134, 4432's comment)
    REGISTER_OOVPAS(SYM_FUN(D3D_AllocContiguousMemory, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, dwSize), PARAM(stk, dwAllocAttributes))),
                    SYM_SIG(3911, 5455)), // Final generic OOVPA: 5455; Removed: 0 // Just calls MmAllocateContiguousMemory.
    REGISTER_OOVPAS(SYM_FUN(D3D_BlockOnResource, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pResource))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3D_BlockOnTime, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, unknown1), PARAM(stk, unknown2))), // TODO: Update unknown parameter name(s) if able. Both parameters do change over time. Likely may need a separate group...
    ...
    REGISTER_OOVPAS_D3D(SYM_FUN(CMiniport_GetDisplayCapabilities, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                        SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_CheckDeviceFormat, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, DeviceType), PARAM(stk, AdapterFormat), PARAM(stk, Usage), PARAM(stk, RType), PARAM(stk, CheckFormat))),
                    SYM_SIG(3911)),
    ...
    REGISTER_OOVPAS_M(SYM_FUN(D3D_CommonSetDebugRegisters, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                      SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(D3D_CommonSetRenderTarget, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pRenderTarget), PARAM(stk, pNewZStencil), PARAM(stk, pUnknown3))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3D_CreateStandAloneSurface, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, unknown1), PARAM(stk, unknown2), PARAM(stk, unknown3), PARAM(stk, unknown4))), // TODO: Update unknown parameter name(s) if able.
                    SYM_SIG(4034)),
    REGISTER_OOVPAS(SYM_FUN(D3D_DestroyResource, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pResource))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_EnumAdapterModes, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, Mode), PARAM(stk, pMode))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_GetAdapterDisplayMode, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, pMode))),
                    SYM_SIG(3911, 4627)),
    REGISTER_OOVPAS(SYM_FUN(D3D_GetAdapterIdentifier, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, Flags), PARAM(stk, pIdentifier))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_GetAdapterModeCount, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, Format))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_GetDeviceCaps, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, DeviceType), PARAM(stk, pCaps))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_KickOffAndWaitForIdle, CALL(std), STACK(/*default*/), PARAMS(PARAM1(void))),
                    SYM_SIG(3911, 4034, 4627, 5028)),
    REGISTER_OOVPAS(SYM_FUN(D3D_LazySetPointParams, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Device))),
                    SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS(SYM_FUN(D3D_RecordStateBlock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pToken))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_SetFence, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Flags))),
                    SYM_SIG(3911, 4034, 4134, 5028, 5558)),
    REGISTER_OOVPAS(SYM_FUN(D3D_SetPushBufferSize, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, PushBufferSize), PARAM(stk, KickOffSize))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_SetTileNoWait, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Index), PARAM(stk, pTile))),
                    SYM_SIG(4627, 5455)), // Final generic OOVPA: 5455; Removed: 0
    REGISTER_OOVPAS(SYM_FUN(Direct3D_CheckDeviceMultiSampleType, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, DeviceType), PARAM(stk, SurfaceFormat), PARAM(stk, Windowed), PARAM(stk, MultiSampleType))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(Direct3D_CreateDevice, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, Adapter), PARAM(stk, DeviceType), PARAM(stk, hFocusWindow), PARAM(stk, BehaviorFlags), PARAM(stk, pPresentationParameters), PARAM(stk, ppReturnedDeviceInterface))),
                    SYM_SIG(3911, 5028)),
    REGISTER_OOVPAS_D3D8(SYM_FUN(Get2DSurfaceDesc, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pPixelContainer), PARAM(stk, dwLevel), PARAM(stk, pDesc))),
                         SYM_SIG(3911, 4034)),
    REGISTER_OOVPAS_D3D8(SYM_FUN(Lock2DSurface, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pPixelContainer), PARAM(stk, FaceType), PARAM(stk, Level), PARAM(stk, pLockedRect), PARAM(stk, pRect), PARAM(stk, Flags))),
                         SYM_SIG(3911)),
    REGISTER_OOVPAS_D3D8(SYM_FUN(Lock3DSurface, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pPixelContainer), PARAM(stk, Level), PARAM(stk, pLockedVolume), PARAM(stk, pBox), PARAM(stk, Flags))),
                         SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_MakeRequestedSpace, CALL(std), STACK(4), PARAMS(PARAM(stk, RequestedSpace))),
    ...
    REGISTER_OOVPAS(SYM_FUN(XMETAL_StartPush, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pDevice))),
                    SYM_SIG(3911)), // Final generic OOVPA: 3911; Removed: 4034??
    REGISTER_OOVPAS(SYM_FUN(IDirect3DVertexBuffer8_Lock, CALL(std), STACK(/*default*/), PARAMS(PARAM(stk, pVertexBuffer), PARAM(stk, OffsetToLock), PARAM(stk, SizeToLock), PARAM(stk, ppbData), PARAM(stk, Flags))),
                    SYM_SIG(4627)),
};
