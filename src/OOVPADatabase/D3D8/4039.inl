...
OOVPA_SIG_MATCH(
    ...
    // D3DDevice_SetSwapCallback+0x04 : mov ecx,[D3D_g_pDevice]
...
OOVPA_SIG_MATCH(
    ...
    // D3DDevice_PersistDisplay+0x04 : mov edi,[D3D_g_pDevice]
    XREF_ENTRY(0x06, XREF_D3D_g_pDevice),
...
OOVPA_SIG_MATCH(
    ...
    // D3DDevice_DrawVerticesUP+0x07 : mov edi,[D3D_g_pDevice]
