...
OOVPATable D3D8LTCG_OOVPA[] = {
    ...
    REGISTER_OOVPAS(SYM_FUN(D3D_BlockOnTime, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, Time), PARAM(stk, MakeSpace))),
    ...
    REGISTER_OOVPAS_D3D(SYM_FUN(CDevice_FreeFrameBuffers, CALL(unk), STACK(4), PARAMS(PARAM(stk, this))),
                        SYM_SIG(4432, 4433)), // stdcall
    REGISTER_OOVPAS_D3D(SYM_FUN(CDevice_InitializeFrameBuffers, CALL(unk), STACK(8), PARAMS(PARAM(stk, this), PARAM(stk, pPresentationParams))),
    ...
    REGISTER_OOVPAS_D3D(SYM_FUN(CMiniport_InitHardware, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, this))),
                        SYM_SIG(1024)),
    REGISTER_OOVPAS(SYM_FUN(D3DCubeTexture_GetCubeMapSurface2, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, this), PARAM(stk, FaceType), PARAM(stk, Level))),
                    SYM_SIG(1024)),
    REGISTER_OOVPAS(SYM_FUN(D3DCubeTexture_GetCubeMapSurface, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, this), PARAM(stk, FaceType), PARAM(stk, Level), PARAM(stk, ppCubeMapSurface))),
                    SYM_SIG(1024)),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3DDevice_CreateTexture, CALL(unk), STACK(8), PARAMS(PARAM(stk, Width), PARAM(stk, Height), PARAM(edx, Levels), PARAM(ecx, Usage), PARAM(eax, Format), PARAM(stk, Pool), PARAM(edi, ppTexture))),
                    SYM_SIG(4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_CreateTexture2, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, Width), PARAM(stk, Height), PARAM(stk, Levels), PARAM(stk, Usage), PARAM(stk, Format), PARAM(stk, D3DResource))),
                    SYM_SIG(1024, 1048)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawIndexedVertices, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType), PARAM(eax, VertexCount), PARAM(stk, pIndexData))),
                    SYM_SIG(1024, 1036, 1037)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawIndexedVerticesUP, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType), PARAM(eax, VertexCount), PARAM(stk, pIndexData), PARAM(stk, pVertexStreamZeroData), PARAM(stk, VertexStreamZeroStride))),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3DDevice_DrawVertices, CALL(unk), STACK(8), PARAMS(PARAM(stk, PrimitiveType), PARAM(stk, StartVertex), PARAM(eax, VertexCount))),
                    SYM_SIG(4039)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_DrawVerticesUP, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, PrimitiveType), PARAM(stk, VertexCount), PARAM(stk, pVertexStreamZeroData), PARAM(stk, VertextStreamZeroStride))),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3DDevice_DrawVerticesUP, CALL(unk), STACK(12), PARAMS(PARAM(stk, PrimitiveType), PARAM(stk, VertexCount), PARAM(ebx, pVertexStreamZeroData), PARAM(stk, VertextStreamZeroStride))),
                    SYM_SIG(2024)),
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3DDevice_EnableOverlay, CALL(unk), STACK(0), PARAMS(/*PARAM(excluded, Enable)*/)),
                    SYM_SIG(2048)),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_Present, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, pSourceRect), PARAM(stk, pDestRect), PARAM(stk, pDummy1), PARAM(stk, pDummy2))),
                    SYM_SIG(1024)),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3DDevice_SetFlickerFilter, CALL(unk), STACK(0), PARAMS(PARAM(esi, Filter))),
                    SYM_SIG(2024)),
    REGISTER_OOVPAS(SYM_FUN(D3DDevice_SetGammaRamp, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, Flags), PARAM(stk, pRamp))),
                    SYM_SIG(1024, 1036)),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3DDevice_SetSoftDisplayFilter, CALL(unk), STACK(0), PARAMS(PARAM(unk, Enable))),
                    SYM_SIG(2048)),
    REGISTER_OOVPAS_D3D(SYM_FUN(CDevice_SetStateUP, CALL(unk), STACK(4), PARAMS(PARAM(stk, this))),
                        SYM_SIG(3911)), // stdcall
    REGISTER_OOVPAS_D3D(SYM_FUN_LTCG(CDevice_SetStateUP, CALL(unk), STACK(0), PARAMS(PARAM(esi, this))),
                        SYM_SIG(4039, 4040)),
    REGISTER_OOVPAS_D3D(SYM_FUN(CDevice_SetStateVB, CALL(unk), STACK(8), PARAMS(PARAM(stk, this), PARAM(stk, unknown2))),
    ...
    REGISTER_OOVPAS(SYM_FUN(D3DResource_GetType, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, pThis))),
                    SYM_SIG(1024)),
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3DResource_GetType, CALL(unk), STACK(0), PARAMS(PARAM(ecx, pThis))),
                    SYM_SIG(2024)),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3D_DestroyResource, CALL(unk), STACK(0), PARAMS(PARAM(edi, pResource))),
                    SYM_SIG(3911)),
    REGISTER_OOVPAS(SYM_FUN(D3D_CommonSetRenderTarget, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, pRenderTarget), PARAM(stk, pNewZStencil), PARAM(stk, unknown3))),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(D3D_CommonSetMultiSampleModeAndScale, CALL(unk), STACK(4), PARAMS(PARAM(eax, this), PARAM(stk, pViewport))),
                    SYM_SIG(5344)),
    REGISTER_OOVPAS(SYM_FUN(D3D_KickOffAndWaitForIdle2, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, unknown1), PARAM(stk, unknown2))),
    ...
    REGISTER_OOVPAS_D3D(SYM_FUN(CDevice_KickOff, CALL(unk), STACK(4), PARAMS(PARAM(stk, this))),
    ...
    REGISTER_OOVPAS(SYM_FUN_LTCG(Direct3D_CreateDevice, CALL(unk), STACK(4), PARAMS(PARAM(eax, BehaviorFlags), PARAM(stk, pPresentationParameters), PARAM(ecx, ppReturnedDeviceInterface))),
                    SYM_SIG(2048, 2060)),
    REGISTER_OOVPAS_D3D8(SYM_FUN(Get2DSurfaceDesc, CALL(unk), STACK(/*default*/), PARAMS(PARAM(stk, pPixelContainer), PARAM(stk, Level), PARAM(stk, pDesc))),
                         SYM_SIG(1024)),
