...
OOVPA_SIG_MATCH(
    ...
    XREF_ENTRY(0x37, XREF_D3DRS_FrontFace),
...
OOVPA_SIG_MATCH(
    ...
    XREF_ENTRY(0x86, XREF_D3DRS_StencilEnable),
    ...
    // mov [e?? + 0x8],0x4032C
    OV_MATCH(0x75, 0xC7),
    OV_MATCH(0x77, 0x08, 0x2C, 0x03, 0x04, 0x00),
...
OOVPA_SIG_MATCH(
    ...
    XREF_ENTRY(0x6F, XREF_D3DRS_StencilFail),
    ...
    // mov [e?? + 0x8],0x40370
    OV_MATCH(0x5E, 0xC7),
    OV_MATCH(0x60, 0x08, 0x70, 0x03, 0x04, 0x00),
