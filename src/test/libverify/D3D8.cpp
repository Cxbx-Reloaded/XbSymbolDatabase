...
static const library_list database_full = {
    ...
    REGISTER_SYMBOLS(D3D_CreateTexture,
                     ...
                     REGISTER_SYMBOL(D3D_CreateTexture_28__LTCG_dl8_edi9, VER_RANGE(4039, 4627))),
    ...
    REGISTER_SYMBOLS(D3D_CMiniport_InitHardware,
                     REGISTER_SYMBOL(CMiniport_InitHardware, VER_RANGE(3911)),
                     REGISTER_SYMBOL(CMiniport_InitHardware_4, VER_RANGE(4531))),
    ...
    REGISTER_SYMBOLS(D3DDevice_BeginPushBuffer,
                     ...
                     REGISTER_SYMBOL(D3DDevice_BeginPushBuffer_0__LTCG_edi1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_DeletePixelShader,
                     ...
                     REGISTER_SYMBOL(D3DDevice_DeletePixelShader_0__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_DeleteVertexShader,
                     ...
                     REGISTER_SYMBOL(D3DDevice_DeleteVertexShader_0__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_EnableOverlay,
                     ...
                     REGISTER_SYMBOL(D3DDevice_EnableOverlay_0__LTCG, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_EndVisibilityTest,
                     ...
                     REGISTER_SYMBOL(D3DDevice_EndVisibilityTest_0__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_GetBackBuffer,
                     ...
                     REGISTER_SYMBOL(D3DDevice_GetBackBuffer_8__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_GetViewportOffsetAndScale,
                     ...
                     REGISTER_SYMBOL(D3DDevice_GetViewportOffsetAndScale_0__LTCG_edx1_ecx2, VER_RANGE(4432))),
    ...
    REGISTER_SYMBOLS(D3DDevice_LightEnable,
                     ...
                     REGISTER_SYMBOL(D3DDevice_LightEnable_4__LTCG_eax1, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3DDevice_LoadVertexShader,
                     REGISTER_SYMBOL(D3DDevice_LoadVertexShader, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_LoadVertexShader_0__LTCG_ecx1_eax2, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_LoadVertexShader_0__LTCG_edx1_eax2, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_LoadVertexShader_4__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_RunPushBuffer,
                     ...
                     REGISTER_SYMBOL(D3DDevice_RunPushBuffer_4__LTCG_eax2, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3DDevice_RunVertexStateShader,
                     REGISTER_SYMBOL(D3DDevice_RunVertexStateShader, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_RunVertexStateShader_4__LTCG_esi2, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SelectVertexShaderDirect,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SelectVertexShaderDirect_0__LTCG_eax1_ebx2, VER_RANGE(4361))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetFlickerFilter,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetFlickerFilter_0__LTCG_esi1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetIndices,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetIndices_4__LTCG_ebx1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetPalette,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetPalette_4__LTCG_eax1, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3DDevice_SetPixelShader,
                     REGISTER_SYMBOL(D3DDevice_SetPixelShader, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetPixelShader_0__LTCG_eax1, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3DDevice_SetPixelShaderConstant,
                     REGISTER_SYMBOL(D3DDevice_SetPixelShaderConstant, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetPixelShaderConstant_4__LTCG_ecx1_eax3, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetRenderTarget,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetRenderTarget_0__LTCG_ecx1_eax2, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetSoftDisplayFilter,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetSoftDisplayFilter_0__LTCG_unk1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetStreamSource,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetStreamSource_0__LTCG_eax1_edi2_ebx3, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetStreamSource_8__LTCG_edx1, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetStreamSource_4__LTCG_eax1_ebx2, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetStreamSource_8__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetTexture,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetTexture_4__LTCG_eax2, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetTexture_4__LTCG_eax1, VER_RANGE(4721))),
    REGISTER_SYMBOLS(D3DDevice_SetTextureState_BorderColor,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetTextureState_BorderColor_0__LTCG_eax1_ebx2, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetTextureState_BorderColor_4__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetTextureState_TexCoordIndex,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetTextureState_TexCoordIndex_4__LTCG_esi1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_MultiplyTransform,
                     ...
                     REGISTER_SYMBOL(D3DDevice_MultiplyTransform_0__LTCG_ebx1_eax2, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetVertexData4f,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetVertexData4f_16__LTCG_edi1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_SetVertexShader,
                     ...
                     REGISTER_SYMBOL(D3DDevice_SetVertexShader_0__LTCG_ebx1, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3DDevice_SetVertexShaderConstant,
                     REGISTER_SYMBOL(D3DDevice_SetVertexShaderConstant, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3DDevice_SetVertexShaderConstant_8__LTCG_edx3, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DDevice_Swap,
                     ...
                     REGISTER_SYMBOL(D3DDevice_Swap_0__LTCG_eax1, VER_RANGE(4034))),
    ...
    REGISTER_SYMBOLS(D3DDevice_UpdateOverlay,
                     ...
                     REGISTER_SYMBOL(D3DDevice_UpdateOverlay_16__LTCG_eax2, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3DResource_GetType,
                     ...
                     REGISTER_SYMBOL(D3DResource_GetType_0__LTCG_ecx1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3D_BlockOnResource,
                     ...
                     REGISTER_SYMBOL(D3D_BlockOnResource_0__LTCG_eax1, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3D_BlockOnResource_0__LTCG_ecx1, VER_RANGE(4039))),
    REGISTER_SYMBOLS(D3D_BlockOnTime,
                     REGISTER_SYMBOL(D3D_BlockOnTime, VER_RANGE(3911)),
                     REGISTER_SYMBOL(D3D_BlockOnTime_4__LTCG_eax1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(D3D_DestroyResource,
                     ...
                     REGISTER_SYMBOL(D3D_DestroyResource_0__LTCG_edi1, VER_RANGE(3911))),
    ...
    REGISTER_SYMBOLS(Direct3D_CreateDevice,
                     ...
                     REGISTER_SYMBOL(Direct3D_CreateDevice_16__LTCG_eax4_ebx6, VER_RANGE(3911)),
                     REGISTER_SYMBOL(Direct3D_CreateDevice_16__LTCG_eax4_ecx6, VER_RANGE(3911)),
                     REGISTER_SYMBOL(Direct3D_CreateDevice_4__LTCG_eax1_ecx3, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3D8_Get2DSurfaceDesc,
                     REGISTER_SYMBOL(Get2DSurfaceDesc, VER_RANGE(3911)),
                     REGISTER_SYMBOL(Get2DSurfaceDesc_0__LTCG_edi1_ebx2_esi3, VER_RANGE(3911)),
                     REGISTER_SYMBOL(Get2DSurfaceDesc_4__LTCG_edi1_esi3, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3D8_Lock2DSurface,
                     REGISTER_SYMBOL(Lock2DSurface, VER_RANGE(3911)),
                     REGISTER_SYMBOL(Lock2DSurface_16__LTCG_esi4_eax5, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3D8_Lock3DSurface,
                     REGISTER_SYMBOL(Lock3DSurface, VER_RANGE(3911)),
                     REGISTER_SYMBOL(Lock3DSurface_16__LTCG_eax4, VER_RANGE(3911))),
    REGISTER_SYMBOLS(D3D_MakeRequestedSpace,
                     ...
                     REGISTER_SYMBOL(D3D_MakeRequestedSpace_4__LTCG_eax2, VER_RANGE(5788))),
